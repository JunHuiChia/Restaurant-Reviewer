...
public class RestaurantListAdapter extends BaseExpandableListAdapter {
    ...
    public RestaurantListAdapter(Context context, List<String> listDataHeader,
    ...
    public View getChildView(int groupPosition, final int childPosition,
        ...
        TextView txtPriceRange = convertView.findViewById(R.id.txt_price_range);

        Restaurant restaurant = (Restaurant) getChild(groupPosition, childPosition);
        txtName.setText(restaurant.getName());
        txtPriceRange.setText(restaurant.getPrice());
    ...
    public View getGroupView(int groupPosition, boolean isExpanded,
        ...
        if (convertView == null) {
            LayoutInflater inflater = (LayoutInflater) this.context
                    .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            convertView = inflater.inflate(R.layout.restaurant_list_group, null);
        }
